        ...
        for epoch in range(epochs):
            for batch_i, (imgs_A, imgs_B) in enumerate(self.data_loader.load_batch(batch_size)):
                ...
                if epoch % sample_interval == 0 and batch_i == 0:
                    ...
                    if epoch % (sample_interval*10) == 0 and batch_i == 0:
                        #save model
...
if __name__ == '__main__':
    jv.start_vm(class_path=bf.JARS)
    gan = Pix2Pix(load_weights = True, timestamp_and_epoch_to_load='2018_11_27_14_06_03/epoch_200')




    #2018_11_27_14_06_03/epoch_200  #attempt at re-creating 1/20 results with model starting from 2018_11_12_14_32_11/epoch_40. Some small scale local artifacts but overall not too bad. Probably needs more training time.
    ...
    #gan.train(epochs=10000, batch_size=8, sample_interval=1)
    jv.kill_vm()
