...
function unmixed_image = k_means_unmixing(num_channels, num_timesteps, num_fluorophores_to_unmix, channels_to_unmix, image_path, save_type, save_path)
    warning('off','all')
    ...
    close all;    
    disp('Running K-Means. This may take a few minutes for large datasets.')
    ...
    write_tiff(unmixed_image, save_path, save_type); 
    disp("EOF: Run Successful")
